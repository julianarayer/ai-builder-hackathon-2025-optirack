...
const badgeVariants = cva(
  "inline-flex items-center rounded-xl border px-2.5 py-0.5 text-xs font-semibold transition-smooth",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary-100 text-primary-500 hover:bg-primary-200",
        secondary:
