  ...
  try {
    ...
    const { data: optimizationRun, error: runError } = await supabase
      ...
      .insert({
        ...
        estimated_overall_improvement_percent: geminiResponse.summary.estimated_overall_improvement_percent,
        estimated_distance_reduction_percent: geminiResponse.summary.estimated_overall_improvement_percent,
        estimated_distance_saved_per_order_m: geminiResponse.summary.estimated_distance_saved_per_order_m,
